...
provides descriptive language. Helpful for screen reading

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display block take up the width
display inline takes up only as much as the elements content
...
allows you to commit/review changes and work on a project fluidly together
